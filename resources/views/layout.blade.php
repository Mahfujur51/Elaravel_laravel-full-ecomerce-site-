			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="{{asset('fontend/images/mainslider.jpg')}}" alt="Los Angeles" style="width:100%;">
					</div>
					
					<?php
					$show_slider=DB::table('tbl_slider')
					->where('slider_publish_satus',1)
					->get();
					foreach ($show_slider as $v_slider) {
						...
						<div class="item">
							<img src="{{URL::to($v_slider->slider_image)}}" alt="New york" style="width:100%;">
						</div>
						<?php }?>
					</div>
								...
								<div class="video-gallery text-center">
									<a href="#">
										<div class="iframe-img">
											<img src="{{URL::to('fontend/images/home/iframe1.png')}}" alt="" />
										</div>
